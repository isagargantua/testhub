...
/**
 * Pure-UI project CRUD. Signs in through the browser only — as the standing
 * tester account by default ({@code reuse.user=true}), or a fresh sign-up when
 * {@code reuse.user=false}. No API shortcuts; every project is uniquely named
 * so a standing account's existing data never collides.
 */
