  ...
  return (
    <div className="auth-shell">
      <section className="auth-hero flex flex-col justify-between">
        <div>
          <div className="section-kicker">Join Your Team</div>
          <h1 className="display-title mt-5 max-w-xl text-5xl leading-[0.92] md:text-6xl">
            Set up your QA workspace in minutes.
          </h1>
          <p className="mt-6 max-w-xl text-base leading-7 text-[#ddcfbf]">
            Create your account to start managing test suites, executing test runs, and collaborating with your QA team.
          </p>
        </div>
        ...
        <div className="space-y-5">
          <div className="metric-grid">
            <div className="metric-chip">
              <div className="section-kicker">Organized</div>
              <div className="mt-3 display-title text-3xl">Suites</div>
              <p className="mt-2 text-sm text-[#d9ccbc]">
                Group test cases by feature, module, or user flow.
              </p>
            </div>
            <div className="metric-chip">
              ...
              <p className="mt-2 text-sm text-[#d9ccbc]">
                Execute and record outcomes for every test case in each run.
              </p>
            </div>
            <div className="metric-chip">
              <div className="section-kicker">Visible</div>
              <div className="mt-3 display-title text-3xl">Dashboard</div>
              <p className="mt-2 text-sm text-[#d9ccbc]">
                See pass rates, result breakdowns, and recent activity at a glance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="auth-form-card">
        <div className="card">
          ...
          <p className="mt-3 text-sm leading-6 text-[#64748b]">
            Create your account to access the TestHub workspace.
          </p>
